...
# Grant Cloud Build service account access to the GitHub token secret
...
# 2.Only create GitHub repo if it doesn't already exist (optional)
...
resource "google_cloudbuildv2_repository" "repo" {
  ...
  parent_connection = "projects/${var.project_id}/locations/${var.region}/connections/${local.connection_name}"
